...
Na základe tohto zistenia bola formulovaná nová hypotéza: spoločný úvodný úsek pravdepodobne zodpovedá DNA priméru prítomnému na začiatku sekvenovaných fragmentov.

%TODO: zformuj do akademického neosobného štýlu ale tak aby postup ale dalsi problem.
Nasledujúcim krokom preto bolo lokálne hľadanie priméru v jednotlivých čítaniach.
Primér sa nevyhľadával iba na začiatku reťazca, ale v celom rozsahu každého čítania, aby sa zachytili aj prípady jeho posunu alebo výskytu vo vnútri sekvencie.
