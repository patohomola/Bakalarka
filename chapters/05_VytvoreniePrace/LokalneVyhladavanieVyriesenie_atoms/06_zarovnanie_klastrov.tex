...
Niektoré klastre obsahovali sekvencie, ktoré sa zhodovali až do dĺžky 100 nukleotidov, čo predstavuje výrazne dlhší úsek než pôvodný primer.

\subsubsection*{Príklad získaného zarovnania}

Na obrázku \ref{fig:zarovnane_retazce} je zobrazený príklad jedného z mnohých nájdených zarovnaných klastrov. Vidno, že jednotlivé čítania obsahujú spoločné úseky, ktoré boli úspešne zarovnané, čo potvrdzuje správnosť detekcie primeru a klastrovania.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{chapters/Figures/ZarovnaneRetazce}
\caption{Príklad zarovnania DNA sekúncií z jedného klastra. Obrázok ukazuje konzenzuálne výsledky viacnásobného zarovnania s viditeľnými zhodami v sekvenciách.}
