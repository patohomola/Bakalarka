...
V tejto práci bol Python použitý na implementáciu rôznych krokov spracovania a analýzy DNA sekvencií, vrátane lokalizácie primérov, klastrovania a viacnásobného zarovnania.
BioPython bol použitý hlavne pre vyhľadávanie primérov a zarovnanie sekvencií pomocou modulu Bio.Align.
