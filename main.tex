...
\input{chapters/motivacia}

\section{Ciele a zadanie práce}
\input{chapters/NaplnUlohy}

\section{Opis dát}
\subsection{V akom stave sú dáta k dispozícii}
\input{chapters/WhatHaveIDoneSoFar/PopisDat/AkeDataMamDispozicii}

\subsection{Aké sú s tým problémy}
\input{chapters/WhatHaveIDoneSoFar/WhatIsTheProblem/KdeSuDlheRetazce}
\input{chapters/WhatHaveIDoneSoFar/WhatIsTheProblem/LokalneVyhladavanie}

\subsection{Aký je očakávaný výstup dát a v akej forme majú byť dáta po spracovaní}
\input{chapters/WhatHaveIDoneSoFar/PopisDat/pozadovanyVystup}


\section{Čo bolo potrebné, aby sa riešenie dalo prakticky realizovať}
%\input{chapters/NavrhRiesieniaUlohy}
\input{chapters/DnaBioSynthezaPolymeraza}
\input{chapters/Nanopore}
\input{chapters/Dorado}
\input{chapters/Cluster}
%\input{chapters/Clover}%idk where the clover chapter go
\input{chapters/WhatHaveIDoneSoFar/RUnningClusteringTool}
\input{chapters/MultiAlignment}
...
\input{chapters/WhatHaveIDoneSoFar/DnaSeqvencing}
\input{chapters/HladanIeDNaRetazci}
\input{chapters/AkoSpustamProces}
