...
\section{Opis dát}
V tejto kapitole sa zameriavam na charakteristiku dát, ktoré sú k dispozícii pre túto prácu, a na problémy spojené s ich spracovaním.
...
V tejto časti popisujem konkrétne kroky, ktoré boli vykonané počas riešenia práce, vrátane spracovania dát, aplikácie algoritmov a vyhodnotenia výsledkov.
...
V práci boli predstavené možnosti a výzvy spojené s ukladaním dát do DNA a spracovaním sekvenačných dát z nanopórového sekvenovania. Navrhnuté a implementované metódy prispievajú k efektívnejšiemu spracovaniu a analýze týchto dát. Cieľ bakalárskej práce bol splnený.
